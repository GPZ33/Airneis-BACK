...
class AppFixtures extends Fixture
{
    ...
    private function loadCategory(ObjectManager $manager): void
    {
        foreach($this->getCategoriesData() as [$name, $imagePath, $description]) {
            ...
            if (in_array($name, ['Tables', 'Canapés', 'Buffets et consoles'])) {
                $image->setCarrousel(true);
            }
    ...
    private function loadProduct(ObjectManager $manager): void
    {
        foreach($this->getProductsData() as [$name, $price, $imagePaths, $description, $details, $categoryName, $stock, $materials]) {
            ...
            if (in_array($name, ["ODGER", "BESTÅ TV", "KALLAX"])) {
    ...
    private function getProductsData(): array 
    {
        return [
            // 8 chaises + 1 épuisée
            ['LES EKEDALEN',59.99,['ekedalen-chaise.avif','ekedalen-chaise2.avif','ekedalen-chaise3.avif'],"Cette chaise en bois confortable est du plus bel effet dans la salle à manger. Profitez de vos repas en toute sérénité grâce à son dossier à barreaux haut et incurvé, ainsi qu'à son assise moelleuse, revêtue d'une housse amovible et lavable.",'Chaise, motif chêne/Orrsta gris clair','Chaises', true,['Hêtre massif','Adhésif', "Panneau de fibres de bois"]],
            ['BERGMUND', 89.99, ['bergmund-chaise.avif','bergmund-chaise2.jpg','bergmund-chaise3.avif'],"Grâce à nos recherches et au développement de nouvelles techniques, la chaise vous offre un confort optimal. Pour changer son style, il suffit de remplacer la housse grise par une housse d'une autre couleur ou d'un autre modèle.", 'Chaise, noir/Gunnared gris moyen','Chaises', true,['Acier','Tissu 100% polyester']],
            ['KARLPETTER', 49.99, ['karlpetter-chaise.avif','karlpetter-chaise2.avif','karlpetter-chaise3.avif'],"Cette chaise rembourrée est particulièrement confortable pour diverses activités : travailler, bricoler ou manger.", 'Chaise, Gunnared vert clair/Sefast noir', 'Chaises', true,['Tissu 100% polyester','Acier', 'Placage lamellé-collé']],
            ['STEFAN',29.99,['stefan-chaise.avif','stefan-chaise2.avif','stefan-chaise3.avif'],"La structure en bois de cette chaise est particulièrement solide et peut résister aux assauts de la vie quotidienne.",'Chaise, brun noir','Chaises', true, ['Pin massif', 'Vernis incolore']],
            ['ODGER', 89.99,['odger-chaise.avif','odger-chaise2.avif','odger-chaise3.webp'],"La coque moulée offre un grand confort dont vous pourrez bénéficier après un montage en 3 clics seulement. Pour assurer sa solidité et son esthétique du bois a été mélangé à du plastique gris charbon, avec un léger effet paillettes.", 'Chaise, anthracite', 'Chaises', true,['Panneau de fibres de bois','Plastique'], true],
            ['ADDE', 15.99, ['adde-chaise.avif','adde-chaise2.avif','adde-chaise3.avif'],"Les chaises peuvent être empilées pour libérer de l'espace quand elles ne servent pas.",'Chaise, noir','Chaises',true,['Acier']],
            ['MÅRENÄS', 119, ['marenaes-chaise.avif','marenaes-chaise2.avif','marenaes-chaise3.avif'],"Un agréable confort avec assise et dossier rembourrés et housses amovibles et lavables.",'Chaise à accoudoirs, noir/Gunnared beige','Chaises', true,['Adhésif','Polypropylène','Tissu 100% polyester','Acier']],
            ['LIDÅS', 34.99,['lidas-chaise.avif','lidas-chaise2.jpg','lidas-chaise3.avif'],"Vous serez confortablement assis grâce à l'assise creusée et à la souplesse reposante du dossier. Le matériau se nettoie en un clin d'œil.",'Chaise, blanc/Sefast blanc','Chaises', true,['Polypropylène','Acier']],
            ...
            // 8 tables + 1 épuisée
            ['LINNMON / ADILS', 34.99,['linnmon-adils-table.avif','linnmon-adils-table2.avif','linnmon-adils-table3.avif'],"Trous pré-percés pour le montage de pieds. Grâce à ses pieds réglables, la table reste stable même sur des surfaces irrégulières.",'Table, blanc, 100x60 cm', 'Tables', true,['Panneau de fibres de bois','Acier']], 
            ['MÖRBYLÅNGA', 499, ['moerbylanga-table.avif','moerbylanga-table2.avif','moerbylanga-table3.avif'],"Le plateau en chêne renforce le style brut de la table et les détails tels que le plateau surélevé et les jointures en queue d'aronde lui donnent un look artisanal. Cette table de caractère peut accueillir de nombreux parents et amis.", 'Table, plaqué chêne teinté brun', 'Tables', true,['Panneau de particules','Placage chêne','Vernis acrylique teinté','Placage chêne épais']],
            ['SKANSNÄS', 599,['skansnaes-table.avif','skansnaes-table2.avif','skansnaes-table3.avif'],"Le style moderne de la table SKANSNÄS s'inspire du design scandinave traditionnel. Avec sa structure robuste, son plateau en placage épais et son système de rallonges, cette élégante table en bois pourra être utilisée pendant longtemps.", 'Table extensible, brun hêtre/plaqué, 115/170 cm', 'Tables', true,['Panneau de particules','Hêtre massif','Adhésif','Placage hêtre épais','Vernis acrylique teinté']],
            ['SKOGSTA',599,['skogsta-table.avif', 'skogsta-table2.avif', 'skogsta-table3.avif'],"Chaque table est unique, avec son grain au motif particulier et ses teintes différentes qui font tout le charme du bois.", 'Table, acacia, 235x100 cm', 'Tables', true,['Acacia massif','Vernis acrylique incolore','Vernis incolore']],
            ['TARSELE', 499, ['tarsele-table.avif','tarsele-table2.avif','tarsele-table3.avif','tarsele-table4.avif'],"Cette table extensible est un mélange parfait de placage en chêne et de métal solide. Elle s'inspire du design industriel des années 50. Le plateau cache aussi une rallonge, idéale lorsque vous recevez des amis.",'Table extensible, plaqué chêne/noir, 150/200x80 cm', 'Tables', true,['Panneau de fibres de bois','Placage chêne','Vernis acrylique teinté','Papier métallisé','Acier']],
            ...
            ['LA SANDSBERG', 48.99,['sandsberg-table.avif','sandsberg-table2.avif','sandsberg-table3.avif'],"Cette table pour 4 personnes combine l'aspect chaleureux du bois avec un métal robuste pour un design élancé agréable à l'œil même dans les petits espaces. Ajoutez-y la chaise SANDSBERG pour créer un look accueillant et coordonné.",'Table, noir, 110x67 cm','Tables', false,['Panneau de particules','Feuille de mélamine','Acier']],
            //8 bureaux + 1 épuisé
            ['LAGKAPTEN / ALEX', 133.99, ['lagkapten-alex.avif','lagkapten-alex2.avif','lagkapten-alex3.avif'],"Un petit espace ne veut pas dire qu'on ne peut pas étudier ou travailler confortablement. Ce bureau ne prend pas beaucoup de place au sol et dispose d'un caisson de tiroirs pour ranger toutes vos affaires.", 'Bureau, effet chêne blanchi/blanc, 120x60 cm', 'Bureaux', true,['Chêne massif','Acier']],
            ['KALLAX', 49.99, ['kallax-bureau.avif', 'kallax-bureau2.avif','kallax-bureau3.avif'],"Un bureau peu profond, au style intemporel, dont le design astucieux permet de cacher les câbles sous le plateau. Facile à personnaliser en ajoutant des portes, des boîtes et d'autres accessoires de la série KALLAX. Vous serez calé avec KALLAX.", 'Bureau, blanc', 'Bureaux', true,['Panneau de fibres de bois']],
            ['TONSTAD', 229, ['tonstad-bureau.avif','tonstad-bureau2.jpg','tonstad-bureau3.jpg' ],"Vous pouvez vous installer à ce bureau blanc pour y réaliser vos loisirs créatifs ou pour partager un repas. La série TONSTAD se caractérise par son design classique et sa finition blanc cassé, qui lui donnent un véritable aspect de qualité.", 'Bureau, plaqué chêne, 140x75 cm', 'Bureaux', true,['Chêne massif']],
            ['MICKE', 119, ['micke-bureau.avif','micke-bureau2.avif','micke-bureau3.avif'],"Combinez votre bureau au design simple et épuré à des caissons à tiroirs de la série MICKE, pour agrandir votre espace de travail. Le passage de câbles à l’arrière est idéal pour cacher les prises et câbles encombrants.",'Bureau, blanc, 142x50 cm', 'Bureaux', true,['Panneau de fibres de bois']],
            ['LAGKAPTEN / ADILS', 49.99,['lagkapten-adils-bureau.avif','lagkapten-adils-bureau2.avif', 'lagkapten-adils-bureau3.jpg'],"Grâce à ses pieds réglables, la table reste stable même sur des surfaces irrégulières. Des matériaux solides et légers et une technique de fabrication qui utilise moins de matières premières.",'Bureau, effet chêne blanchi/blanc, 140x60 cm','Bureaux',true,['Panneau de fibres de bois','Acier']],
            ['MALM', 199,['malm-bureau.avif','malm-bureau2.avif','malm-bureau3.avif'],"Un design épuré qui s'apprécie sous tous les angles : placez le bureau au milieu de la pièce ou contre un mur. Les câbles sont bien cachés à l'intérieur. Installez la tablette coulissante à gauche ou à droite.",'Bureau avec tablette coulissante, blanc, 151x65 cm','Bureaux', true,['Panneau de fibres de bois','Panneau de particules']],
            ['TORALD',24.99,['torald-bureau.avif','torald-bureau2.avif','torald-bureau3.jpg'],"Besoin d'un petit coin bureau ? Alors TORALD est fait pour vous ! Il ne prend pas beaucoup de place dans la pièce, mais est très pratique pour avoir un endroit où étudier, dessiner et travailler.",'Bureau, blanc, 65x40 cm', 'Bureaux', true,['Panneau de particules','Feuille de mélamine','Plastique']],
            ['TROTTEN', 149,['trotten-bureau.avif','trotten-bureau2.avif','trotten-bureau3.avif'],"Ce bureau solide est pensé pour résister à un usage intensif et aux taches de café pendant de nombreuses années. La forme en A des pieds permet d'utiliser tout l'espace sous le plateau du bureau pour y glisser votre chaise ou un rangement.",'Bureau, blanc, 160x80 cm','Bureaux', true,['Panneau de particules','Feuille de mélamine','Plastique','Acier']],
            ['BEKANT', 279, ['bekant-bureau.avif','bekant-bureau2.avif','bekant-bureau3.avif'],"Ce bureau solide est pensé pour résister à un usage intensif et aux taches de café pendant de nombreuses années. Les câbles restent parfaitement cachés en dessous grâce à une solution de rangement astucieuse.",'Bureau, blanc, 160x80 cm','Bureaux', false,['Panneau de particules','Feuille de mélamine','Plastique','Acier']],
            // 8 consoles et buffets + 1 épuisé
            ['BESTÅ',390,['besta.avif','besta2.avif','besta3.avif'],"Cette commode permet de ranger des affaires et d'avoir une surface pour exposer des objets ou poser des plats de service pendant les repas.",'Combinaison rangement portes, brun noir/Hedeviken/Stubbarp plaqué chêne, 180x42x74 cm','Buffets et consoles', true,["Panneau de fibres de bois"]],
            ['VIHALS',149,['vihals-buffet.avif','vihals-buffet2.avif','vihals-buffet3.avif'],"La série de rangement VIHALS se compose de meubles permettant d'obtenir un style uniforme à travers toutes les pièces de la maison. Le mélange de tiroirs et de tablettes permet de mettre de l'ordre dans le salon, le couloir ou n'importe quelle pièce.",'Buffet, blanc, 140x37x75 cm','Buffets et consoles', true,['Panneau de particules','Panneau de fibres de bois']],
